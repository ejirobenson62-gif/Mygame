const questions = [
{q: "Eat Indomie everyday", a: "Eat Jollof Rice everyday", roast: ["Indomie addict detected!", "Jollof is king!"]},
...
let currentQ = 0, score = 0, lives = 3, timer;
let timeLeft = 10;
...
result.innerText = "You chose: " + (choice === 'A'? optA.innerText : optB.innerText);
